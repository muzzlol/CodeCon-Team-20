...
diabetes_model = pickle.load(open('/Users/muzz/CodeCon-Team-20/Multiple Disease Prediction System/saved models/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('/Users/muzz/CodeCon-Team-20/Multiple Disease Prediction System/saved models/heart_disease_model.sav','rb'))

pneumonia_model= pickle.load(open('/Users/muzz/CodeCon-Team-20/Multiple Disease Prediction System/saved models/xraymodel.sav','rb'))
